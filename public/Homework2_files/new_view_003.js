(function() {
  ...
  Homework2.Views.Enrollments.NewView = (function(superClass) {
    extend(NewView, superClass);

    NewView.prototype.template = JST["backbone/templates/enrollments/new"];
      ...
      return this.collection.create(this.model.toJSON(), {
        success: (function(_this) {
          return function(enrollment) {
            _this.model = enrollment;
            return window.location.hash = "/" + _this.model.id;
          };
        })(this),
        error: (function(_this) {
          return function(enrollment, jqXHR) {
